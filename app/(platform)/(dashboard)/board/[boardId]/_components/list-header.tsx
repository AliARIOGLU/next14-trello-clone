...
export const ListHeader = ({ data }: ListHeaderProps) => {
  ...
  const handleSubmit = (formData: FormData) => {
    ...
    // Eğer update etmek istediğin title değerini yine aynı girdiysen boşa api isteğine gerek yok böyle disable etmek yeterli
    if (title === data.title) {
  ...
  // Escape basıldığında ya da formun dışuna tıklanınca update ediliyor hook yardımıyla
